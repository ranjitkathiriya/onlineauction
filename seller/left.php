<div class="title_box">Menu</div>
      <ul class="left_menu">
        <li class="odd"><a href="change.php?id=<?php
		
		 echo $_SESSION['uname']; ?>">Change Password </a></li>
        
        <li class="even"><a href="main.php">Product History</a></li>
        

        <li class="odd"><a href="update.php?id=<?php
		
		 echo $_SESSION['uname']; ?>">Change Profile</a></li>
        <li class="even"><a href="contact.php">Contact Us</a></li>
