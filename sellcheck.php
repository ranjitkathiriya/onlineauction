...
$querycity="select regid from registration where uname='$name'";
	...
	{	    
 $sql="INSERT INTO itemmaster(itid,itname,subid,descri,regid,itadddate,itlastdate,itprice,itbidprice,new) VALUES('itid','$itname', '$subid', '$descri', '$regid','$itadddate', '$itlastdate', '$itprice', '$itbidprice','$new')";
