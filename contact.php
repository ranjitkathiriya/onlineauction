...
<div class="crumb_navigation"> Navigation: <a href="index.php">Home</a> &loz; <span class="current">Contact Us</span> </div>
...
?>
  ...
  <p>&nbsp;</p>
                ...
                <p>
                    ...
                    <input type="email" name="uname" class="long" required/>
                </p>
				 <p>
                    <label>Mobile *
                    </label>
                    <input type="text" maxlength="10" name="mno" class="long" required/>
                </p>
  <p>
				<label>Detail *    </label>
