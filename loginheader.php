  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
        ...
        <li class="divider"></li>
        <li><a href="store.php" class="nav2">Stores</a></li>
        <li class="divider"></li>
        
        <li><a href="sell.php" class="nav4">Sell</a></li>
        <li class="divider"></li>
       
        <li><a href="mission.php" class="nav6">About Us</a></li>
        <li class="divider"></li>
        <li><a href="contact.php" class="nav7">Contact Us</a></li>
	 
	
	<li class="divider"></li>
	<li><?php echo "&nbsp;You Logged As Mr." .$_SESSION['name']; ?></li>
	 <?php 
	 {
	if  ($_SESSION['utype'] == '0')
	   
	 {
	echo " <li><a href='admin/' class='nav10'>My Account</a></li>";
	}
	else if($_SESSION['utype'] == '1')
{
	echo " <li><a href='buyer/' class='nav10'>My Account</a></li>";
	
	}
	else
	
{
echo " <li><a href='seller/' class='nav10'>My Account</a></li>";
}
	}
	?>
	
	<li class="divider"></li><li><a href="logout.php" class="nav5">Logout</a></li>
      </ul>
