  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
        ...
        <li class="divider"></li>
        <li><a href="notifi.php" class="nav2">Notifications</a></li>
        <li class="divider"></li>
        <?php /*?><li><a href="/" class="nav3">Bids</a></li>
        <li class="divider"></li><?php */?>
        <li><a href="main.php" class="nav4">Products on Bids</a></li>
        <li class="divider"></li>
        <li><a href="account.php" class="nav9">Account</a></li>
        <li class="divider"></li>
	...
	<li><?php
		...
		echo "&nbspYou Logged As Mr.".$_SESSION['name'];
		?></li>
      </ul>
