<?php include("header.php")?>
   <div class="crumb_navigation"> Navigation: <a href="index.php">Home</a> &loz; <span class="current">Account</span> </div> <div class="left_content">
    ...
    <div class="center_content">
      ...
      <div class="prod_box">
        <table width="428" height="314" border="1" align="center"  bordercolor="#2DA8EE">
